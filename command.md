/ralph-loop:ralph-loop "Unified FeCIM Visualizer - Single GUI App
...
When unified app builds, runs, all demos work in tabs, and all tests pass, output: UNIFIED APP COMPLETE" --max-iterations 1000 --completion-promise "UNIFIED APP COMPLETE"
