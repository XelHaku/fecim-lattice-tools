...
Located in [`docs/sky130-reference/`](file://<local-path>):
...
> 📖 **Full design rules:** See [SKY130_QUICK_REFERENCE.md](file://<local-path>) section on "Critical Design Rules"
...
- **Metal stack specs:** [SKY130_QUICK_REFERENCE.md#metal-layer-stack](file://<local-path>)
- **Pin placement:** [SKY130_QUICK_REFERENCE.md#fecim-custom-cell-design-guidelines](file://<local-path>)
- **OpenLane config:** [SKY130_QUICK_REFERENCE.md#openlane-integration](file://<local-path>)

---

## Next Steps

1. ✅ **Review** [`SKY130_QUICK_REFERENCE.md`](file://<local-path>) for detailed specs
